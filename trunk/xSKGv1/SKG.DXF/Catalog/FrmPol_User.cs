...
namespace SKG.DXF.Catalog
{
    ...
    public partial class FrmPol_User : SKG.DXF.FrmInRight
    {
        ...
        public override Menuz Menu
        {
            get
            {
                var menu = new Menuz() { Caption = "Người dùng", Level = 3, Order = 5, Picture = @"Resources\user.png" };
                return menu;
            }
        }
        #endregion
        ...
        protected override void ResetInput()
        {
            ...
            txtAcc.Text = null;
            txtPass.Text = null;
            dteBirth.DateTime = Extend.Session.Current.ToBirth(18);
        ...
        {
            var a = dteBirth.DateTime.ToAge(Extend.Session.Current) < 18 ? false : true;
            if (!a)
            {
