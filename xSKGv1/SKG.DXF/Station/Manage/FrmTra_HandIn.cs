...
namespace SKG.DXF.Station.Manage
{
    ...
    /// Cổng vào
    /// </summary>
    public partial class FrmTra_HandIn : SKG.DXF.FrmInput
    {
        ...
        public override Menuz Menuz
        {
            get
            {
                var menu = new Menuz() { Caption = "Nhập bằng tay", Level = 3, Order = 26, Picture = @"Icons\GateIn.png" };
                return menu;
            }
        }
        #endregion
