...
namespace SKG.UTL
{
    ...
    public sealed class ZDateTime
    {
        ...
        /// <summary>
        /// Set current date & time default by system
        /// </summary>
        public ZDateTime() { Now = DateTime.Now; }

        /// <summary>
        /// Set current date & time default by user
        /// </summary>
        /// <param name="now">Set date & time</param>
        public ZDateTime(DateTime now) { Now = now; }
        ...
        /// </summary>
        /// <returns>DateTime's start of last year</returns>
        ...
        /// <summary>
        /// Get end of last year
        /// </summary>
        /// <returns>DateTime's end of last year</returns>
