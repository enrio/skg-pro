...
namespace BXE.PRE.Manage
{
    ...
    public partial class FrmGateOut : SKG.DXF.FrmInput
    {
        ...
        public override Menuz Menuz
        {
            get
            {
                var menu = new Menuz() { Caption = "Cổng ra", Level = 3, Order = 27, Picture = @"Icons\Base.png" };
                return menu;
            }
        }
        #endregion
        ...
        protected override void PerformPrint()
        {
            ...
            rpt.DataSource = Sample._bll.Tra_Detail.Sumary(out _sum, fr, to, DAL.Tra_DetailDAL.Group.Z, Global.Session.User.Id);
        ...
        {
            int sum;
            _dtb = Sample._bll.Tra_Detail.GetInDepot(out sum);
        ...
        private void Invoice(bool isOut = false)
        {
            ...
            try
            {
                var v = (Tra_Vehicle)Sample._bll.Tra_Vehicle.Select(cbbNumber.Text);
                ...
                var tb = Sample._bll.Tra_Detail.InvoiceOut(o, ref  day, ref  hour, ref  money, ref  price1, ref  price2, isOut);
