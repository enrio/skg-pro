...
namespace BXE.DAL
{
    public class DetailDAL : CsoDAL, UTL.DAL.ItfDAL
    {
        ...
        /// <returns></returns>
        public DataTable SumaryDateOutByUser_1(out decimal total, DateTime fr, DateTime to, long UserId)
        {
            total = 0;
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public DataTable SumaryDateOutByUser_2(out decimal total, DateTime fr, DateTime to, long UserId)
        {
            total = 0;
        ...
        public DataTable SumaryDateInByUser(out decimal total, DateTime fr, DateTime to, long UserId)
        {
            total = 0;
