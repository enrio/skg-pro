    ...
    public partial class FrmGateIn : SKG.DXF.FrmInRight
    {
        ...
        protected override bool UpdateObject()
        {
            try
            {
                ...
                if (Sample._bll.Tra_Detail.Update(o) != null) return true;
                else
                {
        ...
        protected override bool InsertObject()
        {
            try
            {
                ...
                var id = Sample._bll.Tra_Vehicle.CheckExist(txtNumber.Text);
                ...
                if (id != new Guid()) // kiểm tra biển số xe trong danh sách các xe được quản lí
                {
                    ...
                    if (Sample._bll.Tra_Detail.Insert(o) != null) return true;
                    else
                    {
                        XtraMessageBox.Show(STR_IN_GATE, Text);
                        return false;
                ...
                else
                {
                    try
                    {
                        ...
                        if (Sample._bll.Tra_Vehicle.Insert(ve) != null) // thêm xe nào vào danh sách xe cộ
                        {
                            var o = new Tra_Detail()
                            {
                                Pol_UserInId = Global.Session.User.Id,
        ...
        private void lkeGroup_EditValueChanged(object sender, EventArgs e)
        {
            ...
            lkeKind.Properties.DataSource = Sample._bll.Tra_Kind.Select(id);
            lkeKind.ItemIndex = 0;
        }
        ...
        {
            _dtb = Sample._bll.Tra_Detail.GetDataInMinute();
            if (_dtb == null) return;
