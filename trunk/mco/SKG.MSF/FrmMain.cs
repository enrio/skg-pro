...
namespace SKG.MSF
{
    ...
    public partial class FrmMain : Form
    {
        public FrmMain()
        {
            ...
            bsiServer.Text = String.Format("[SV:{0} | DB:{1}]", cnn.DataSource, cnn.Database);
            bsiUser.Text = null;
            bsiTimer.Text = null;
        }
        ...
        private void tmrMain_Tick(object sender, EventArgs e)
        {
            ...
            {
                bsiTimer.Text = Global.Session.Current.ToStringVN();
        ...
        private void AfterLogon()
        {
            ...
            bsiUser.Text = Global.Session.User.Name;
            ...
            foreach (var r in d)
            {
                ...
                var a = typeof(SKG.MSF.Home.Grant.Level2).Namespace;
                var t = Type.GetType(String.Format("{0}.{1}", a, r.Code));
                if (t == null)
                {
                    a = typeof(SKG.MSF.Home.Catalog.Level2).Namespace;
