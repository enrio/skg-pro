...
namespace UTL.HSH
{
    public sealed class WinDow
    {
        ...
        public static List<PropertyData> ListInfo(string win32)
        {
            ...
            using (ManagementObjectSearcher mbs = new ManagementObjectSearcher(Select + win32))
            {
        ...
        public static object GetInfo(string win32, string key)
        {
            string s = "";
        ...
        {
            return GetInfo(Win32_BaseBoard, "SerialNumber").ToString();
        }

        public static string ProcessorID()
        {
            return GetInfo(Win32_Processor, "ProcessorID").ToString();
        }
        ...
        public static string MACAddress()
        {
            using (ManagementClass mc = new ManagementClass(Win32_NetworkAdapterConfiguration))
            {
                ...
                {
                    if (s == String.Empty) // only return MAC Address from first card
