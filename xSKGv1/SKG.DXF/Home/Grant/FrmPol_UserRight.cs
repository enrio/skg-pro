...
namespace SKG.DXF.Home.Grant
{
    ...
    public partial class FrmPol_UserRight : FrmInput
    {
        ...
        public override Menuz Menuz
        {
            get
            {
                var type = typeof(FrmPol_UserRight);
        ...
        #region Constants
        private const string STR_TITLE = "Gán quyền người dùng";
